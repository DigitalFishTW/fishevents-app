...
<div class="ui text container" ng-controller="modifyBoat">
    ...
    <div class="ui segments" style="max-width: 650px; margin: 0 auto">
        ...
        <div class="ui segment" style="max-width: 650px; margin: 0 auto">
            ...
            <form class="ui form" method="post" ng-submit="updateBoat($event)" novalidate>
                <h2 class="ui dividing header">Informations</h2>
                <div class="field">
                    <label>Name</label>
                    <div class="ui input">
                ...
                <div class="fields">
                    ...
                    <div class="four wide field">
                        ...
                        <select class="ui fluid dropdown" name="ais_type" ng-model="data.type">
                            ...
                            <option value="Passenger Vessels">Passenger Vessels</option>
                            <option value="High Speed Craft">High Speed Craft</option>
                            <option value="Tugs &amp; Special Craft">Tugs &amp; Special Craft</option>
                            <option value="Fishing">Fishing</option>
                            <option value="Pleasure Craft">Pleasure Craft</option>
                            <option value="Navigation Aids">Navigation Aids</option>
                            <option value="Unspecified Ships">Unspecified Ships</option>
                        </select>
                    </div>
                    <div class="four wide field">
                ...
                <div class="fields">
                    <div class="four wide field">
                        <label>Radio</label>
                        <div class="ui input">
                            <input type="text" name="radio" ng-model="data.radio" placeholder="Radio">
                        </div>
                    </div>
                    <div class="twelve wide field">
                        <label>Identify</label>
                        <div class="ui input">
                            <input type="text" name="identify" ng-model="data.identify" placeholder="Identify">
                        </div>
                    </div>
                </div>
                <h2 class="ui dividing header">Address and status</h2>
                <div class="fields">
                    <div class="ten wide field">
                        <label>Home port</label>
                        <div class="ui input">
                            <input type="text" name="home_port" ng-model="data.home_port" placeholder="Address">
                        </div>
                    </div>
                ...
                <div class="field">
                    <label>Status</label>
                    <div class="ui input">
                        <input type="text" name="status" ng-model="data.status" placeholder="Status">
                    </div>
                </div>
